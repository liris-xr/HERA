  ...
  <section class="project-card-container">
    ...
    <div id="content">
      <div class="card-header-row">
       ...
       <button class="fav-btn" @click.stop="toggleFav" :class="{ 'is-fav': project.fav === 1 }">
          <IconSvg 
            url="/icons/fav.svg" 
      ...
      <span class="card-meta">{{$t('projectsView.projectCard.updatedOn') + date.toLocaleDateString($t('locale'))}}</span>
      <br>
      ...
      <div class="toggle-container" @click.stop>
        ...
        <span class="toggle-label">{{ project.published ? $t('projectsView.projectCard.projectPublished') : $t('projectsView.projectCard.projectPrivate') }}</span>
      </div>
    </div>
  </section>
</template>
