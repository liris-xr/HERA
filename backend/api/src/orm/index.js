...
import ArPreset from "./models/arPreset.js";
import ArAction from "./models/arAction.js";
...
ArProject.hasMany(ArPreset, { as: 'presets', foreignKey: 'projectId', onDelete: 'CASCADE' });
...
ArPreset.belongsTo(ArProject, { as: 'project', foreignKey: 'projectId' });
ArPreset.hasMany(ArAction, { as: 'actions', foreignKey: 'presetId', onDelete: 'CASCADE' });

ArAction.belongsTo(ArPreset, { as: 'preset', foreignKey: 'presetId' });
ArAction.belongsTo(ArAsset, { as: 'targetAsset', foreignKey: 'targetAssetId' });
ArAction.belongsTo(ArScene, { as: 'targetScene', foreignKey: 'targetSceneId' });
...
export { ArUser, ArProject, ArScene, ArAsset, ArLabel, ArMesh, ArPreset, ArAction }
